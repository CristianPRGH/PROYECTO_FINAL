...
<body class="bg-[#F7F3E9] h-screen flex flex-col">
    <header id="index-footer" class=" h-[10%] flex self-bottom border-b-4 border-b-[#A0DDE6] bg-[#A8E6CF]">
        <section class="w-full">
            <i id="toggleLeftMenu" class="material-symbols-rounded w-full h-full cursor-pointer text-white text-3xl flex items-center justify-center">menu</i>
        </section>
        <section class="w-full">
            <i id="homePage" class="material-symbols-rounded w-full h-full cursor-pointer text-white text-3xl flex items-center justify-center">home</i>
        </section>
        <section class="w-full">
            <i id="toggleRightMenu" class="material-symbols-rounded w-full h-full cursor-pointer text-white text-3xl flex items-center justify-center">account_circle</i>
        </section>
    </header>
    ...
    <aside id="menu-bookfilters" class="flex flex-col justify-between bg-[#A8E6CF] fixed bottom-0 w-full h-[90%] p-8 z-10 -left-full opacity-0">
    ...
    <aside id="index-rightmenu" class="flex flex-col justify-between bg-[#A8E6CF] fixed bottom-0 w-full h-[90%] -right-full p-6 z-10 opacity-0">
